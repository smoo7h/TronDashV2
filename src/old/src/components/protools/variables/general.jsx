...
//components/CustomDropdown/CustomDropdown.jsx
// ##############################
...
const widgetStories = [
  {
    ...
    body: (
      <div>
        <p>
          TronDash.com, an innovative utility that enables you to see your div
          earnings on the most popular dApps utilizing the Tron blockchain.
        </p>
        <p>
          There’s a 2% burn rate for all DASH transactions and a predefined
          amount of just under 21MM, a total that will be widdled down through a
          continuous transaction burn.
        </p>
        <p>
          Not just an economic experiment, DASH is backed by the TronDash
          ecosystem.
        </p>
        <p>
          Revenue from advertising and forthcoming Dapps will be used to buy
          exchange-listed DASH and perform transactions, serving to accelerate
          the scarcity of DASH and value of your DASH holdings.
        </p>
      </div>
    ),
  ...
  },
  {
    ...
    body: (
      <div>
        <p>
          DASH will be airdropped in waves to those who make use of the TronDash
          tools
        </p>
        <p>
          For those who want to compound their DASH exposure, staking mechanisms
          will be available, allowing you to seamlessly grow your DASH crypto
          portfolio to HODL while the number of DASH diminishes
        </p>
      </div>
    ),
  },
  {
    ...
    body: (
      <div>
        ...
        <p>
          DASH will enjoy the spikes and stability from continued innovation of
          the TronDash network, delivering trailblazing utilities that set the
          precedent for other dApp development
        </p>
        <p>
          A stability floor for DASH, built on the burn and buybacks from
          platform activity earnings and deflationary transaction pressure
        </p>
      </div>
    ),
    footer: (
